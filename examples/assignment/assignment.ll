...
define dso_local i32 @main() #0 {
  ...
  %9 = load i32, i32* %y
  %10 = add i32 %9, %8
  call i32 (ptr, ...) @printf(ptr noundef @formatIntNewLine, i32 noundef %10)
  store i32 3, i32* %z
  %12 = load i32, i32* %z
  call i32 (ptr, ...) @printf(ptr noundef @formatIntNewLine, i32 noundef %12)
  store i32 15, i32* %z
  ...
  store i32 %16, i32* %a
  %17 = load i32, i32* %a
  call i32 (ptr, ...) @printf(ptr noundef @formatIntNewLine, i32 noundef %17)
  %b = alloca double
  ...
  call i32 (ptr, ...) @printf(ptr noundef @formatFloatNewLine, double noundef %21)
  %c = alloca i32
  store i32 5, i32* %c
  %23 = load i32, i32* %c
  %24 = srem i32 %23, 3
  store i32 %24, i32* %c
  %25 = load i32, i32* %c
  call i32 (ptr, ...) @printf(ptr noundef @formatIntNewLine, i32 noundef %25)
  ret i32 0
}
